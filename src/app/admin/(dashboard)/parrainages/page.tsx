...
export default function AdminReferralsPage() {
  ...
  return <div style={{ display: 'grid', gap: '1rem' }}>
    <header><h1 style={{ margin: 0, fontSize: '1.5rem', color: '#0F172A' }}>Parrainages</h1><p style={{ margin: '.25rem 0 0', color: '#64748B', fontSize: '.78rem' }}>Données réelles : lien utilisé, inscription, codes à 10 % et paiement qualifiant.</p></header>

...
function RegisterForm() {
  ...
  async function handleGoogleSignup() {
    ...
    try {
      ...
      if (result?.error) {
        setGoogleError('La connexion Google est temporairement indisponible. Réessayez dans quelques instants.');
      }
    } catch {
      setGoogleError('La connexion Google est temporairement indisponible. Vérifiez votre connexion puis réessayez.');
    } finally {

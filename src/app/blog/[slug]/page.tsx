...
const CONTENT: Record<string, { sections: { heading?: string; body: string }[] }> = {
  'comment-preparer-omra-10-etapes': {
    sections: [
      ...
      { heading: 'Étape 5 — Réserver votre guide SAFARUNA', body: "Votre guide est la clé de tout. Il vous accueillera à l'aéroport, vous expliquera chaque geste dans votre langue, vous emmènera dans les lieux saints et les lieux historiques, et sera disponible pour vos questions à toute heure. Réservez au minimum 6 semaines à l'avance pour les meilleures disponibilités." },
      ...
      { heading: 'Étape 8 — Organiser votre hébergement', body: "Idéalement, choisissez un hôtel à moins de 1 km du Masjid Al-Haram. Plus c'est près, plus vous pouvez prier souvent sans vous épuiser. Les prix varient considérablement selon la saison. Le Ramadan est la période la plus chargée — réservez 3 à 4 mois à l'avance. Votre guide SAFARUNA peut vous recommander des hôtels selon votre budget." },
      ...
      { body: "Ces 10 étapes, votre guide SAFARUNA les connaît par cœur. Il vous accompagnera à chacune d'elles, bien avant que vous ne posiez le pied à l'aéroport de Jeddah." },
    ],
  },

  'les-7-tours-du-tawaf': {
    sections: [
      { body: "Le Tawaf — les 7 tours effectués autour de la Kaaba dans le sens anti-horaire — est le premier rite de l'Omra. C'est aussi l'un des actes d'adoration les plus symboliques de l'Islam. Pourquoi 7 tours ? Que représente chaque passage ? Ce que les savants en disent va vous surprendre." },
  ...
  'guide-visa-omra-2025': {
    sections: [
      ...
      { body: "La bonne nouvelle : si vous avez un guide SAFARUNA, le visa n'est plus un obstacle. Notre équipe accompagne chaque pèlerin dans la constitution de son dossier, vérifie les documents avant soumission et suit le traitement. Aucune mauvaise surprise à l'aéroport." },
    ],
  },
  ...
  'difference-omra-hajj': {
    sections: [
      ...
      { heading: 'La récompense de l\'Omra', body: "Le Prophète ﷺ a dit : «L'Omra est une expiation pour les péchés commis entre elle et la suivante. Et le Hajj mabrur n'a pas d'autre récompense que le Paradis.» (Bukhari & Muslim). Même si l'Omra est facultative, sa valeur devant Allah est immense. Certains savants recommandent d'accomplir l'Omra au moins une fois par an si on en a la capacité." },
      ...
      { heading: 'Pourquoi commencer par l\'Omra ?', body: "La plupart des savants recommandent d'accomplir l'Omra avant le Hajj. C'est une façon de découvrir les Lieux Saints, d'apprendre les rituels dans un cadre moins intense, et d'arriver au Hajj avec une expérience déjà acquise. SAFARUNA propose des programmes Omra qui sont aussi une préparation au Hajj — avec des guides qui vous enseignent les rituels des deux pèlerinages." },
      { body: "Que vous vous prépariez pour une Omra, que vous envisagiez le Hajj, ou que vous cherchiez à mieux comprendre votre religion — votre guide SAFARUNA est là pour vous accompagner, expliquer, et faire vivre ces rituels dans toute leur profondeur." },
    ],
  },
};

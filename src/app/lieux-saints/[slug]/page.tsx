...
const LIEUX: Record<'Makkah' | 'Madinah', LieuSimple[]> = {
  Makkah: [
    ...
    },
    {
      ...
      tag: 'Eau sacrée · Omra',
      tagColor: '#1A4A8A',
      description: "L'eau la plus sacrée du monde, jaillie miraculeusement pour Hajar et Ismaël ﷺ, et qui coule sans interruption depuis. Le Prophète ﷺ a dit : «L'eau de Zamzam vaut ce pour quoi elle est bue.»",
      history: "Ibrahim ﷺ laissa Hajar et le nourrisson Ismaël dans la vallée aride de Makkah sur l'ordre d'Allah. Quand l'eau manqua, Hajar courut sept fois entre Safa et Marwa. L'ange Jibril frappa la terre et l'eau jaillit. Hajar s'écria «Zommi! Zommi!» pour retenir l'eau. Cette source n'a jamais tari depuis.",
  ...
  Madinah: [
    ...
    },
    {
      ...
      history: "Le Prophète ﷺ posa les premières pierres de Masjid Quba en l'an 1 de l'Hégire, assisté de ses Compagnons. Le Coran y fait référence : «Une mosquée fondée dès le premier jour sur la piété mérite mieux que tu y pries» (9:108).",
    ...
    },
    {
      ...
      tagColor: '#8B2A1A',
      description: "Le Prophète ﷺ a dit : «Uhud est une montagne qui nous aime et que nous aimons.» Lieu de la bataille d'Uhud (an 3 de l'Hégire), où 70 Compagnons tombèrent en martyre, dont Hamza ibn Abd Al-Muttalib (رضي الله عنه), l'oncle bien-aimé du Prophète ﷺ.",
    ...
    },
    {
      ...
      tag: 'Cimetière sacré',
      tagColor: '#5A4E3A',
      description: "Le cimetière de Madinah abrite plus de 10 000 Compagnons du Prophète ﷺ, ainsi que plusieurs membres de sa famille. Le Prophète ﷺ le visitait régulièrement.",
      history: "",
    ...
    },
    {
      ...
      tagColor: '#1D5C3A',
      description: "C'est à cet endroit que le Prophète ﷺ dirigea la toute première prière du Vendredi de l'histoire de l'Islam, lors de son Hégire. Il s'arrêta dans la vallée de Banu Salim pendant le déplacement de Quba vers Madinah.",
      history: "Après 14 jours à Quba, le Prophète ﷺ se dirigea vers Madinah un vendredi matin. À mi-chemin, dans le quartier de Banu Salim ibn Awf, il s'arrêta et fit la prière du vendredi. Cette prière est considérée comme la première Jumu'ah de l'Islam.",
    ...
    },
    {
      ...
      tagColor: '#1A4A8A',
      description: "Un ensemble de sept petites mosquées marquant les positions tenues par le Prophète ﷺ et ses Compagnons lors de la Bataille du Fossé (Al-Khandaq). Sur la suggestion de Salman Al-Farisi (رضي الله عنه), les musulmans creusèrent un fossé de plusieurs kilomètres pour défendre Madinah.",
    ...
    },
    {
      ...
      history: "Le 17 Ramadan de l'an 2 de l'Hégire, Allah envoya des anges en renfort. 70 polythéistes furent tués, 70 faits prisonniers. 14 musulmans moururent martyrs.",
    ...
    },
    {
      ...
      tag: 'Lieu rare',
      tagColor: '#5A2D82',
      description: "Un puits paisible aux abords de Madinah, dans le jardin de Quba, où le Prophète ﷺ aimait s'asseoir. Un espace à l'écart du tumulte, rarement visité, qui offre une intimité spirituelle rare.",
      history: "Le Prophète ﷺ aimait ce jardin de Quba. Un jour, sa bague portant «Muhammad Rasul Allah» tomba dans ce puits. Uthman (رضي الله عنه), alors Calife, tenta pendant 3 jours de la retrouver sans succès.",
    ...
    },
    {
      ...
      tag: "Prière de l'Aïd",
      tagColor: '#1D5C3A',
      description: "Le Prophète ﷺ y accomplit la prière de l'Aïd en plein air, et selon la tradition, un nuage lui fit de l'ombre lors de la khutbah. Cette petite mosquée, à deux pas de Masjid An-Nabawi, est un trésor méconnu.",
      ...
      <main style={{ backgroundColor: '#FDFBF7', paddingTop: '8rem' }}>
        ...
        <section style={{ backgroundColor: '#1A1209', color: '#FDFBF7', padding: '4rem 1.5rem', marginTop: '1rem' }}>
          <div style={{ maxWidth: 720, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1rem', lineHeight: 1.75, color: '#D4C8B0', maxWidth: 600 }}>{lieu.description}{lieu.history ? ` ${lieu.history}` : ''}</p>
          </div>
        </section>

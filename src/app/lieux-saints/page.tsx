  ...
  Makkah: [
    {
      ...
      history: "Selon la tradition islamique, Ibrahim ﷺ posa les fondations de la Kaaba avec son fils Ismaël ﷺ sur l'emplacement où Adam avait initialement bâti un sanctuaire. Le Prophète Muhammad ﷺ purifia la Kaaba des idoles lors de la conquête de Makkah, restaurant son état originel de maison d'Allah.",
    ...
    },
    {
      ...
      tag: 'Révélation',
      tagColor: '#5A2D82',
      description: "La montagne de la Lumière abrite la Grotte de Hira, où le Prophète ﷺ recevait la révélation. C'est ici que Jibril descendit pour la première fois avec les versets d'Al-Alaq : «Lis au nom de ton Seigneur qui a créé». La montée comprend 1652 marches.",
      history: "Le Prophète ﷺ se retirait régulièrement dans la grotte pour méditer et se recueillir. La nuit du 17 Ramadan de l'an 610, Jibril lui apparut pour la première fois. Khadijah (رضي الله عنها) fut la première à croire en lui — «Tu es le Messager d'Allah».",
    ...
    },
    {
      ...
      tag: 'Hajj',
      tagColor: '#1D5C3A',
      description: "C'est ici que des millions de pèlerins résident 3 nuits lors du Hajj. C'est aussi ici que s'accomplit le jet de pierres sur les trois Jamarat — symbole du rejet du shaytân par Ibrahim ﷺ. Hors Hajj, le silence du lieu est saisissant.",
    ...
    },
    {
      ...
      history: "Le Prophète ﷺ y prononça l'un de ses derniers sermons, lors du Hajj d'adieu en l'an 10 de l'Hégire : «Ô gens, votre sang et vos biens vous sont sacrés... Aucun Arabe n'est supérieur à un non-Arabe, ni aucun non-Arabe à un Arabe, sinon par la piété.» Ce discours est souvent appelé la première déclaration universelle des droits de l'homme.",
    ...
    },
    {
      ...
      history: "Ibrahim ﷺ avait laissé Hajar et le nourrisson Ismaël dans une vallée aride sur l'ordre d'Allah. Quand l'eau manqua, Hajar courut entre les deux collines en cherchant de l'aide. Allah fit jaillir Zamzam. Le Coran dit : «Safa et Marwa font partie des rites d'Allah» (2:158).",
      dua: "إِنَّ الصَّفَا وَالْمَرْوَةَ مِن شَعَائِرِ اللَّهِ",
      duaTrad: "Safa et Marwa font partie des rites d'Allah. (Al-Baqarah 2:158 — à réciter en commençant le Sa'i)",
    ...
    },
    {
      ...
      tag: 'Hajj',
      tagColor: '#1D5C3A',
      description: "La halte sacrée entre Arafat et Mina. Après le coucher du soleil à Arafat, les pèlerins marchent vers Muzdalifah, prient Maghrib et Isha ensemble, dorment à la belle étoile et collectent quelques cailloux pour le jet de Mina. Une nuit unique dans une vie.",
    ...
    },
    {
      ...
      tag: 'Eau sacrée · Omra',
      tagColor: '#1A4A8A',
      description: "L'eau la plus sacrée du monde, jaillie miraculeusement pour Hajar et Ismaël ﷺ, et qui coule sans interruption depuis. Le Prophète ﷺ a dit : «L'eau de Zamzam vaut ce pour quoi elle est bue.» Elle guérit, étanche, fortifie — aucun pèlerin ne repart sans en avoir bu.",
      history: "Ibrahim ﷺ laissa Hajar et le nourrisson Ismaël dans la vallée aride de Makkah sur l'ordre d'Allah. Quand l'eau manqua, Hajar courut sept fois entre Safa et Marwa. Désespérée, elle posa Ismaël — et l'ange Jibril frappa la terre ou Ismaël frappa du talon, et l'eau jaillit. Hajar s'écria «Zommi! Zommi!» (arrête! arrête!) pour retenir l'eau. Cette source n'a jamais tari depuis.",
      dua: "اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا وَرِزْقًا وَاسِعًا وَشِفَاءً مِنْ كُلِّ دَاءٍ",
      duaTrad: "Ô Allah, je Te demande une science utile, une subsistance abondante et une guérison de toute maladie.",
      features: ['Coule sans interruption', 'Miracle de Hajar', 'Du\'a de guérison'],
    },
  ],
  Madinah: [
    {
      ...
      tag: 'Essentiel',
      tagColor: '#C9A84C',
      description: "La mosquée du Prophète ﷺ à Madinah — la deuxième plus sacrée de l'Islam. Une prière y vaut mieux que 1000 prières ailleurs, sauf au Masjid Al-Haram. Elle abrite le tombeau du Prophète ﷺ, ainsi que la Rawdah, l'un des espaces les plus recherchés par les pèlerins.",
      history: "À son arrivée à Madinah lors de l'Hégire, le Prophète ﷺ laissa sa chamelle avancer librement. Là où elle s'agenouilla, il fit construire la mosquée avec ses propres mains. Elle était initialement très simple — des palmiers en guise de colonnes, de la terre battue comme sol. Elle a été agrandie de nombreuses fois depuis.",
      ...
      features: ['Tombeau du Prophète ﷺ', 'Meilleure que 1000 prières', 'Agrandie plusieurs fois'],
    },
    {
      slug: 'masjid-quba',
      title: 'Masjid Quba',
      ...
      history: "Le Prophète ﷺ posa les premières pierres de Masjid Quba en l'an 1 de l'Hégire, assisté de ses Compagnons. Le Coran y fait référence : «Une mosquée fondée dès le premier jour sur la piété mérite mieux que tu y pries» (9:108). Ce verset est souvent interprété par les savants comme une référence à Masjid Quba.",
      ...
      features: ['Équivalent d\'une Omra', 'Fondée à l\'Hégire', 'Première mosquée'],
    },
    {
      slug: 'jabal-uhud',
      title: 'Jabal Uhud',
      ...
      tagColor: '#8B2A1A',
      description: "Le Prophète ﷺ a dit : «Uhud est une montagne qui nous aime et que nous aimons.» Lieu de la bataille d'Uhud (an 3 de l'Hégire), où 70 Compagnons tombèrent en martyre, dont Hamza ibn Abd Al-Muttalib (رضي الله عنه), l'oncle bien-aimé du Prophète ﷺ. Un lieu de recueillement intense.",
      history: "En l'an 3 de l'Hégire, 3000 Qurayshites attaquèrent Madinah. Les archers postés sur le mont quittèrent leur position contre les ordres du Prophète ﷺ. Le Prophète ﷺ lui-même fut blessé.",
      ...
      features: ['Cimetière des martyrs', 'Bataille an 3 Hégire', 'Hamza (ra)'],
    },
    {
      slug: 'al-baqi',
      title: 'Al-Baqi\'',
      ...
      tag: 'Cimetière sacré',
      tagColor: '#5A4E3A',
      description: "Le cimetière de Madinah abrite plus de 10 000 Compagnons du Prophète ﷺ, ainsi que plusieurs membres de sa famille dont Uthman ibn Affan (رضي الله عنه), Fatimah Az-Zahraa (رضي الله عنها) selon certains savants, et Ibrahim, le fils du Prophète ﷺ. Le Prophète ﷺ le visitait régulièrement.",
      history: "",
    ...
    },
    {
      ...
      tagColor: '#1A4A8A',
      description: "La mosquée aux deux Qiblas. C'est ici que des Compagnons du Prophète ﷺ ont prié vers les deux directions de l'Islam en une seule prière : alors qu'ils priaient en direction de Jérusalem, Allah révéla l'ordre de se tourner vers la Kaaba, et toute l'assemblée pivota ensemble, en pleine prière.",
      history: "«Nous voyons ton visage se tourner vers le ciel. Nous allons donc t'orienter vers une qibla qui te plaira. Tourne donc ton visage vers la Masjid Al-Haram.» (Al-Baqarah 2:144)",
    ...
    },
    {
      ...
      tagColor: '#1D5C3A',
      description: "C'est à cet endroit que le Prophète ﷺ dirigea la toute première prière du Vendredi (Jumu'ah) de l'histoire de l'Islam, lors de son Hégire. Il s'arrêta dans la vallée de Banu Salim pendant le déplacement de Quba vers Madinah.",
      history: "Après 14 jours à Quba, le Prophète ﷺ se dirigea vers Madinah un vendredi matin. À mi-chemin, dans le quartier de Banu Salim ibn Awf, il fut rejoint par un grand nombre de fidèles. Il s'arrêta et fit la prière du vendredi. Cette prière est considérée comme la première Jumu'ah de l'Islam.",
      ...
      features: ["Premier Jumu'ah", 'Hégire', 'Lieu rare à visiter'],
    },
    {
      slug: 'wadi-al-aqiq',
      title: 'Wadi Al-Aqiq',
      ...
      tag: 'Fleuve béni',
      tagColor: '#5A2D82',
      description: "Un fleuve aux abords de Madinah que le Prophète ﷺ a décrit comme béni. Il dit : «Il m'a été ordonné de prier dans cette vallée bénie.» Lieu de spiritualité, moins visité que les autres sites.",
      history: "Le Prophète ﷺ y priait souvent et l'aimait particulièrement pour son aspect verdoyant et tranquille.",
      ...
      features: ['Fleuve béni', 'Prière du Prophète ﷺ', 'Lieu de retraite'],
    },
    {
      slug: 'sept-mosquees',
      title: 'Les Sept Mosquées',
      nameAr: 'المساجد السبعة',
      tag: 'Bataille du Fossé',
      tagColor: '#1A4A8A',
      description: "Un ensemble de sept petites mosquées marquant les positions tenues par le Prophète ﷺ et ses Compagnons lors de la Bataille du Fossé (Al-Khandaq). Sur la suggestion de Salman Al-Farisi (رضي الله عنه), les musulmans creusèrent un fossé de plusieurs kilomètres pour défendre Madinah — une stratégie inédite dans la péninsule arabique face à une coalition de nombreuses tribus.",
      history: "En l'an 5 de l'Hégire, Salman Al-Farisi proposa le fossé — inconnu des Arabes jusque-là. La coalition, incapable de franchir l'obstacle, se retira après le siège. Cet épisode valut à Salman (رضي الله عنه) la parole du Prophète ﷺ : «Salman est des nôtres, de la famille du Prophète.»",
      dua: "حَسْبُنَا اللَّهُ وَنِعْمَ الْوَكِيلُ",
      duaTrad: "Allah nous suffit, et Il est le meilleur garant. (Al-Imran 3:173 — du'a des Compagnons sous pression)",
      features: ['Bataille du Fossé', 'Sept mosquées', 'Salman Al-Farisi (ra)'],
    },
    {
      slug: 'badr',
      title: 'Badr',
      ...
      history: "Le 17 Ramadan de l'an 2 de l'Hégire, Allah envoya des anges en renfort. 70 polythéistes furent tués, 70 faits prisonniers. 14 musulmans moururent martyrs. Allah révéla la sourate Al-Anfal en entier à propos de cette bataille — appelée le «Jour de la Distinction» (Yawm Al-Furqan).",
    ...
    },
    {
      ...
      tag: 'Lieu rare',
      tagColor: '#5A2D82',
      description: "Un puits paisible aux abords de Madinah, dans le jardin de Quba, où le Prophète ﷺ aimait s'asseoir. Un espace à l'écart du tumulte, rarement visité, qui offre une intimité spirituelle rare aux pèlerins qui le connaissent.",
      history: "Le Prophète ﷺ aimait ce jardin de Quba. Un jour, sa bague portant «Muhammad Rasul Allah» tomba dans ce puits. Uthman (رضي الله عنه), alors Calife, tenta pendant 3 jours de la retrouver sans succès. Abu Bakr (رضي الله عنه) et Umar (رضي الله عنه) s'assirent eux aussi au bord de ce même puits.",
    ...
    },
    {
      ...
      tag: "Prière de l'Aïd",
      tagColor: '#1D5C3A',
      description: "Le Prophète ﷺ y accomplit la prière de l'Aïd en plein air, et selon la tradition, un nuage lui fit de l'ombre lors de la khutbah. Cette petite mosquée, à deux pas de Masjid An-Nabawi, est un trésor méconnu que les guides SAFARUMA vous feront découvrir.",
      history: "C'est dans cet espace à ciel ouvert que le Prophète ﷺ dirigea la prière de l'Aïd Al-Adha. Un nuage (ghamamah) lui fit de l'ombre par forte chaleur — d'où le nom.",
      ...
      features: ["Prière de l'Aïd", 'Nuage miraculeux', "À deux pas du Nabawi"],
    },
    {
      slug: 'rawdah',
      title: 'Ar-Rawdah Al-Mubaraka',
      nameAr: 'الروضة الشريفة',
      tag: 'Jardin du Paradis',
      tagColor: '#1D5C3A',
      description: "Un espace précis à l'intérieur de Masjid An-Nabawi. Le Prophète ﷺ a dit : «Ce qui est entre ma maison et mon minbar est un jardin parmi les jardins du Paradis.» (Sahih Al-Bukhari, Sahih Muslim). Il est aujourd'hui repérable par son tapis vert, distinct du reste de la mosquée.",
      history: "À l'époque du Prophète ﷺ, cet espace se trouvait entre sa maison — où il vivait avec son épouse Aïcha (رضي الله عنها) et où il fut par la suite enterré — et le minbar d'où il prêchait. Avec les extensions successives de la mosquée, la maison a été englobée dans l'enceinte, et la Rawdah désigne aujourd'hui cette zone précise entre le tombeau et le minbar.",
      dua: "اللَّهُمَّ إِنِّي أَسْأَلُكَ مِن فَضْلِكَ وَرَحْمَتِكَ",
      duaTrad: "Ô Allah, je Te demande de Ta grâce et de Ta miséricorde.",
      features: ['Jardin du Paradis', 'Entre maison et minbar', 'Tapis vert distinctif'],
    },
    {
      slug: 'masjid-bani-unayf',
      title: 'Masjid Bani Unayf (Al-Musabbih)',
      nameAr: 'مسجد بني أنيف',
      tag: 'Histoire · Quba',
      tagColor: '#1D5C3A',
      description: "Une petite mosquée au sud-ouest de Masjid Quba, nommée d'après Banu Unayf, un clan allié des Banu Amr ibn Awf de Quba. Elle est aussi connue sous le nom de Masjid Al-Musabbih.",
      history: "La tradition rapporte que le Prophète ﷺ y pria en rendant visite à Talha ibn Al-Bara Al-Anifi (رضي الله عنه), un compagnon alité. Une autre tradition situe ici sa prière de l'aube (Fajr) le jour de l'Hégire — d'où le nom Al-Musabbih.",
      dua: "لَا بَأْسَ طَهُورٌ إِنْ شَاءَ اللَّهُ",
      duaTrad: "Ce n'est rien, ce sera une purification, si Allah le veut. (du'a du Prophète ﷺ lors de la visite à un malade)",
      features: ['Clan Banu Unayf', 'Aussi appelée Al-Musabbih', 'Près de Quba'],
    },
    {
      slug: 'masjid-ad-dira',
      title: 'Masjid Ad-Dira (Bouclier)',
      nameAr: 'مسجد الدرع',
      tag: "Bataille d'Uhud",
      tagColor: '#8B2A1A',
      description: "Située entre Masjid An-Nabawi et le mont Uhud, cette mosquée marque l'endroit où le Prophète ﷺ revêtit son armure (dira') avant de se diriger vers la bataille d'Uhud.",
      history: "En l'an 3 de l'Hégire, avant la bataille d'Uhud, le Prophète ﷺ s'arrêta ici pour revêtir sa cotte de mailles et ses armes, entouré de ses Compagnons, avant de poursuivre la marche vers le mont Uhud.",
      dua: "رَبَّنَا أَفْرِغْ عَلَيْنَا صَبْرًا وَثَبِّتْ أَقْدَامَنَا",
      duaTrad: "Notre Seigneur, déverse sur nous la patience et affermis nos pas. (Al-Baqarah 2:250)",
      features: ["Avant la bataille d'Uhud", 'Armure du Prophète ﷺ', 'Entre Nabawi et Uhud'],
    },
    {
      slug: 'palmeraie-salman-al-farisi',
      title: 'La palmeraie de Salman Al-Farisi',
      nameAr: 'بستان سلمان الفارسي',
      tag: 'Histoire · Compagnon',
      tagColor: '#5A2D82',
      description: "L'histoire de l'affranchissement de Salman Al-Farisi (رضي الله عنه), compagnon d'origine perse installé à Madinah. Réduit en esclavage, il négocia sa liberté contre la plantation de 300 palmiers et 40 onces d'or. Le Prophète ﷺ planta lui-même les jeunes palmiers avec l'aide des Compagnons — tous prirent racine.",
      history: "Un lingot d'or provenant du butin de guerre permit de régler le reste de la dette, et Salman (رضي الله عنه) devint un homme libre. Il resta l'un des compagnons les plus proches du Prophète ﷺ, à l'origine de la stratégie du fossé lors du siège de Madinah. (Musnad Ahmad) Aucun site précis n'est aujourd'hui identifié pour cette palmeraie — l'histoire reste associée à la région de Madinah dans son ensemble.",
      dua: "رَبِّ أَوْزِعْنِي أَنْ أَشْكُرَ نِعْمَتَكَ",
      duaTrad: "Mon Seigneur, permets-moi d'être reconnaissant envers Ton bienfait. (An-Naml 27:19)",
      features: ['Salman Al-Farisi (ra)', 'Affranchissement', 'Compagnon persan'],
    },
  ],
};
...
const DURATIONS: Record<string, { time: string; dist?: string }> = {
  ...
  'zamzam':             { time: 'Sur place', dist: 'Dans le Haram' },
  'sept-mosquees':      { time: '~1h', dist: '3 km de Madinah' },
  'bir-aris':           { time: '~30 min', dist: '3 km du An-Nabawi' },
  'masjid-ghamamah':    { time: '~30 min', dist: '200 m du An-Nabawi' },
  'rawdah':             { time: 'Sur place', dist: 'Dans le An-Nabawi' },
  'masjid-bani-unayf':  { time: '~30 min', dist: '3 km de Madinah' },
  'masjid-ad-dira':     { time: '~30 min', dist: '4 km de Madinah' },
};
      ...
      <section style={{ background: '#0D0A06', paddingTop: '11rem', paddingBottom: '5rem', paddingLeft: '2rem', paddingRight: '2rem', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 700, margin: '0 auto' }}>
          <div style={{ display: 'inline-block', background: 'rgba(201,168,76,0.15)', border: '1px solid rgba(201,168,76,0.3)', color: '#F0D897', fontSize: '0.62rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', padding: '0.3rem 1rem', borderRadius: 50, marginBottom: '1.5rem' }}>
            Encyclopédie · 24 lieux historiques
          </div>
          <h1 style={{ fontFamily: 'var(--font-cormorant, serif)', fontSize: 'clamp(2.5rem, 7vw, 4.5rem)', fontWeight: 600, color: 'white', lineHeight: 1.1, marginBottom: '1.25rem' }}>
            Les Lieux historiques de l'Islam
          </h1>
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1rem', lineHeight: 1.75, maxWidth: 520, margin: '0 auto 2.5rem' }}>
            Histoire, signification spirituelle et du'a pour chacun des 24 lieux les plus sacrés de Makkah et Madinah.
          </p>

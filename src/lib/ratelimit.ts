...
// Four photo slots per candidature; separate quota does not consume submission attempts.
export const guideApplicationPhotoRatelimit = makeRatelimit(12, '1 h', 'safaruma:rl:guide-application-photo')

...
export const lieuxSaints: Record<string, LieuSaint> = {
  'masjid-al-haram': {
    ...
    locationKicker: 'LIEU HISTORIQUE · LA MECQUE',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          {
            type: 'paragraph',
            content: "La Kaaba est au cœur de trois rituels fondamentaux de la omra et du Hajj, chacun porteur d'une signification profonde.",
          },
          {
            type: 'rituals',
            items: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Pas nécessairement. Le Tawaf effectué dans le cadre de la omra (Tawaf al-Qudum) ou du Hajj requiert l'état d'ihram. Le Tawaf de dévotion volontaire (Tawaf al-Nafl) peut être accompli en tout temps sans ihram, simplement en état de pureté rituelle (wudu).",
      },
      {
  ...
  'safa-marwa': {
    ...
    location: 'La Mecque, Hijaz',
    locationKicker: 'LIEU HISTORIQUE · LA MECQUE',
    excerpt: "Les deux collines sacrées entre lesquelles Hajar courut sept fois pour trouver de l'eau pour son fils Ismaël, commémorées par le rituel de la Sa'i, pilier de la omra.",
    readingTime: 9,
    ...
    sections: [
      {
        ...
        content: [
          ...
          { type: 'paragraph', content: "À l'issue de ce septième passage, l'ange Jibrîl frappa la terre de son talon et la source de Zamzam jaillit. Hajar se précipita pour retenir l'eau en disant «Zommi, Zommi» (retiens-toi, retiens-toi) — c'est l'étymologie traditionnelle du nom Zamzam. Cette course désespérée d'une mère pour son enfant, empreinte de foi absolue en Allah, est commémorée par tout pèlerin accomplissant la omra ou le Hajj jusqu'à la fin des temps." },
        ],
      ...
      },
      {
        ...
        title: 'Importance spirituelle',
        content: [
          { type: 'paragraph', content: "La Sa'i est l'un des piliers (arkan) de la omra et du Hajj, ce qui signifie que son omission invalide le pèlerinage, et qu'aucune expiation ne peut la compenser. Elle est régie par la Sunna du Prophète ﷺ qui l'accomplit lors de ses pèlerinages et la prescrivit avec précision à ses Compagnons." },
    ...
    faq: [
      ...
      { question: "La Sa'i est-elle valide si on n'est pas en ihram ?", answer: "La Sa'i effectuée dans le cadre de la omra ou du Hajj requiert d'être en état d'ihram. En dehors de ces contextes rituels, la Sa'i n'est pas pratiquée." },
      ...
      { question: "La Sa'i est-elle un pilier ou une condition de la omra ?", answer: "Selon la majorité des savants (Shafi'i, Hanbali, Maliki), la Sa'i est un pilier (rukn) dont l'omission invalide la omra. Selon les Hanafis, c'est une obligation (wajib) dont l'omission est réparable par une expiation (dam)." },
  ...
  'zamzam': {
    ...
    faq: [
      ...
      { question: "Peut-on prendre l'eau de Zamzam avant de faire la omra ?", answer: "Oui. L'eau de Zamzam peut être bue à tout moment lors de votre séjour à La Mecque, avant, pendant ou après les rituels. Il n'existe pas de restriction temporelle." },
    ],
  },
  ...
  'mina': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'paragraph', content: "Pour les pèlerins de la omra, il est important de noter que Mina ne fait pas partie des rites de la Omra. Les Jamarat, le sacrifice, les nuits à Mina sont des rites propres au Hajj (pilier du Dhul Hijjah). Un pèlerin de la omra peut visiter Mina hors saison du Hajj comme site historique, mais la vallée n'a alors pas sa charge émotionnelle habituelle." },
        ],
      },
      {
        id: 'rituels',
      ...
      },
      {
        ...
        content: [
          { type: 'list', items: [
            ...
            "Croire que Mina fait partie des rites de la omra : Mina est exclusivement réservé aux rites du Hajj.",
    ...
    faq: [
      { question: "Mina est-il inclus dans les rites de la omra ?", answer: "Non. Mina et les Jamarat sont des rites spécifiques au Hajj, accomplis les 10, 11, 12 et éventuellement 13 Dhul Hijjah. Un pèlerin venant pour la omra n'accomplit pas les rites de Mina." },
  ...
  'arafat': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          { type: 'paragraph', content: "Pour les pèlerins de la omra, il est fondamental de savoir qu'Arafat ne fait pas partie des rites de la omra. La Omra comprend l'Ihram, le Tawaf, la Sa'i et le rasage/coupe des cheveux — point. Arafat est spécifique au Hajj. Un pèlerin peut cependant visiter la plaine hors saison du Hajj pour la méditation et la mémoire historique." },
        ],
      },
      {
        id: 'rituel',
      ...
      },
      {
        ...
        content: [
          { type: 'list', items: [
            ...
            "Croire qu'Arafat est un rite de la omra : c'est exclusivement un rite du Hajj.",
    ...
    faq: [
      ...
      { question: "La omra inclut-elle une station à Arafat ?", answer: "Non. La omra comprend l'Ihram, le Tawaf, la Sa'i et le rasage/coupe des cheveux. Arafat est un rite spécifique au Hajj (le 9 Dhul Hijjah)." },
  ...
  'jabal-al-nour': {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'paragraph',
            content: "La visite de Jabal al-Nour est recommandée à titre de connaissance historique et de méditation spirituelle, mais elle ne constitue ni un rite de la omra ni une obligation du Hajj. Les savants islamiques rappellent qu'elle relève de la dévotion personnelle et de la connaissance de la Sîra prophétique, non d'un acte d'adoration prescrit.",
          },
          {
            type: 'callout',
        ...
        content: [
          {
            type: 'list',
            items: [
              "Croire que la visite est un rite obligatoire de la omra ou du Hajj : elle n'en fait pas partie. C'est une démarche culturelle et spirituelle volontaire.",
    ...
    faq: [
      { question: "Faut-il monter Jabal al-Nour pendant la Omra ?", answer: "Non, c'est une visite historique et spirituelle facultative, pas un rite de la omra. Les rites de la omra sont l'ihram, le Tawaf, le Sa'i et le rasage ou coupe des cheveux. Jabal al-Nour est une démarche de connaissance de la Sîra prophétique." },
  ...
  'masjid-al-jumua': {
    ...
    locationKicker: 'LIEU HISTORIQUE · MÉDINE',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          {
            type: 'paragraph',
            content: "La mosquée n'est pas un lieu de rituel prescrit dans le cadre de la omra ou du Hajj. La visite est une démarche spirituelle et historique volontaire. Prier la Jumua ici ne remplace pas l'obligation hebdomadaire, mais la confirme dans un contexte unique.",
          },
        ],
      },
      {
  ...
  'wadi-al-aqiq': {
    ...
    sections: [
      {
        ...
        content: [
          ...
          {
            type: 'paragraph',
            content: "La vallée est également mentionnée dans un hadith de Muslim (n° 1186) relatant que le Prophète ﷺ s'y arrêtait pour prier et y formulait l'intention de la omra. Ces deux témoignages concordants des plus grands compilateurs de hadiths confirment l'importance du lieu.",
          },
        ],
      },
      {
    ...
    faq: [
      ...
      { question: "Y a-t-il d'autres lieux historiques dans la vallée ?", answer: "Masjid al-Miqat est le lieu historique principal situé dans la vallée. Historiquement, plusieurs jardins et domaines du Prophète ﷺ et des compagnons étaient également dans cette zone, mais ils ne sont plus identifiables aujourd'hui." },
    ],
  },

  ...
  Madinah: [
    {
      ...
      tag: 'Essentiel',
      tagColor: '#C9A84C',
      description: "La mosquée du Prophète ﷺ à Madinah — la deuxième plus sacrée de l'Islam. Une prière y vaut mieux que 1000 prières ailleurs, sauf au Masjid Al-Haram. Elle abrite la Rawdah Al-Mubaraka — «un jardin du Paradis» selon le Prophète ﷺ.",
      ...
      features: ['Rawdah', 'Tombeau du Prophète ﷺ', 'Meilleure que 1000 prières'],
    },
    {
      slug: 'masjid-quba',
      title: 'Masjid Quba',
    ...
    },
    {
      ...
      tagColor: '#8B2A1A',
      description: "Le Prophète ﷺ a dit : «Uhud est une montagne qui nous aime et que nous aimons.» Lieu de la bataille d'Uhud (an 3 de l'Hégire), où 70 Compagnons tombèrent en martyre, dont Hamza ibn Abd Al-Muttalib ﷺ, l'oncle bien-aimé du Prophète ﷺ. Un lieu de recueillement intense.",
      ...
      features: ['Cimetière des martyrs', 'Bataille an 3 Hégire', 'Hamza ﷺ'],
    },
    {
      slug: 'al-baqi',
      title: 'Al-Baqi\'',
    ...
    },
    {
      ...
      features: ['Bataille du Fossé', 'Sept mosquées', 'Salman Al-Farisi ﷺ'],
    },
    {
      slug: 'badr',
      title: 'Badr',
      ...
      <section style={{ background: '#0D0A06', paddingTop: '11rem', paddingBottom: '5rem', paddingLeft: '2rem', paddingRight: '2rem', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 700, margin: '0 auto' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: '1rem', lineHeight: 1.75, maxWidth: 520, margin: '0 auto 2.5rem' }}>
            Histoire, signification spirituelle et du'a pour chacun des 20 lieux les plus sacrés de Makkah et Madinah.
          </p>

...
const GUIDES_DATA = [
  ...
  { slug: 'fatima-al-omari', gender: 'femme', zones: ['makkah', 'madinah'], name: 'Fatima Al-Omari', title: 'Guide femme · Familles', initials: 'FA', location: 'Makkah', experience: 8, rating: 4.95, reviews: 178, languages: ['🇫🇷 Français', '🇲🇦 Darija'], services: ['Guide femme', 'Rituels Omra', 'Van 9pl', 'Familles'], price: 320, available: true, isOfficial: false, gradient: 'linear-gradient(135deg, #082818, #1D5C3A)', avatarGradient: 'linear-gradient(135deg, #9FE1CB, #1D9E75)', badge: 'Guide femme', badgeColor: '#1D5C3A', bio: 'Spécialisée dans l\'accompagnement des femmes et des familles. Ustadha certifiée, elle adapte son rythme à chaque groupe avec douceur et profondeur spirituelle.' },
...
function TunnelContent() {
  ...
  const filterGuide = (g: Guide) => {
    ...
    if (lang && !g.languages.some(l => l === lang)) return false;
    return true;
  };

...
const GUIDES: Record<string, {
  ...
  'naim-laamari': {
    ...
    bioFull: [
      ...
      "Diplômé de l'Institut des Sciences Islamiques de Makkah, Naïm a approfondi sa connaissance des Lieux Saints auprès des cheikhs et historiens les plus réputés de la région pendant plus d'une décennie. Cette formation rigoureuse lui permet de transmettre des connaissances islamiques avec précision, humilité et profondeur — bien au-delà de ce que proposent les guides de passage.",
      ...
      "Les sites historiques de Makkah n'ont aucun secret pour lui. Il connaît l'histoire de la Kaaba depuis Ibrahim ﷺ et Ismaïl ﷺ, les multiples rénovations du Masjid Al-Haram à travers les siècles, les événements fondateurs de l'Hégire. À Jabal Nour, il raconte la révélation de la première sourate avec un détail et une émotion qui marquent les pèlerins à jamais. À Jabal Thawr, il décrit la nuit dans la grotte avec Abu Bakr as-Siddiq, l'araignée et la colombe — des récits vivants qui rendent l'histoire islamique tangible et présente.",
      "Naïm est également formé à l'accompagnement des personnes à mobilité réduite (PMR). Il connaît les itinéraires accessibles en fauteuil roulant au sein du Masjid Al-Haram, les entrées prioritaires, les espaces réservés, et les étages climatisés du Mas'a. Il adapte systématiquement le rythme de la visite à l'état physique et l'âge du pèlerin, prenant toutes les précautions nécessaires pour que la Omra soit accomplie dans la dignité, le confort et la sérénité.",
      ...
      "Ce qui distingue Naïm de nombreux autres guides, c'est sa vision de l'accompagnement. Pour lui, guider des pèlerins à Makkah n'est pas un métier — c'est une responsabilité spirituelle. Chaque pèlerin qui lui est confié est un invité d'Allah ﷻ. Cette vision explique son attention au moindre détail, sa patience infinie face aux questions, et la fidélité remarquable de ses clients qui reviennent voyage après voyage et recommandent SAFARUMA à leur entourage.",
      "Les pèlerins qui ont voyagé avec Naïm témoignent unanimement : sa présence transforme la Omra. Au-delà de la logistique et de la connaissance, c'est sa chaleur humaine, sa sincérité et sa foi communicative qui rendent chaque voyage inoubliable. Yasmine B. (Paris) : « Un frère, pas un guide. » Omar K. (Lyon) : « Il nous a fait aimer encore plus ces lieux bénis. » Fatou D. (Dakar) : « Professionnel, ponctuel, bienveillant — il connaît Makkah comme sa poche. »",
    ],
    certifications: [

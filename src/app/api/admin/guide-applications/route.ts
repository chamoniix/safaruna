  ...
  const [applications, total, statusCounts] = await Promise.all([
    prisma.guideApplication.findMany({
      ...
      select: {
        ...
        makkahIncludedDetails: true,
        makkahOtherDetails: true,
        madinahIncludedDetails: true,
        madinahOtherDetails: true,
        pricingDetails: true,
      ...
      data: {
        ...
        guideProfile: {
          create: {
            ...
            university: application.educationDetails || application.education,

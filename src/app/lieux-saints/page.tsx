...
const LIEUX: Record<'Makkah' | 'Madinah', Lieu[]> = {
  Makkah: [
    ...
    },
    {
      ...
      history: "Ibrahim ﷺ laissa Hajar et le nourrisson Ismaël dans la vallée aride de Makkah sur l'ordre d'Allah. Quand l'eau manqua, Hajar courut sept fois entre Safa et Marwa. Désespérée, elle posa Ismaël — et l'ange Jibrîl frappa la terre ou Ismaël frappa du talon, et l'eau jaillit. Hajar s'écria «Zommi! Zommi!» (arrête! arrête!) pour retenir l'eau. Cette source n'a jamais tari depuis.",
    ...
    },
    {
      ...
      history: "Après la conquête de Makkah en l'an 8 de l'Hégire, 12 000 musulmans marchèrent vers Taïf. Les Hawazin et Thaqif tendirent une embuscade. L'avant-garde fut repoussée. Le Prophète ﷺ tint ferme sur sa mule blanche en criant : «Je suis le Prophète, cela n'est pas un mensonge.» Les Compagnons se rallièrent et la victoire fut totale. Allah révéla : «Le jour de Hunayn, quand votre grand nombre vous avait enorgueilli...» (9:25).",
  ...
  Madinah: [
    ...
    },
    {
      ...
      tag: 'Lieu rare',
      tagColor: '#5A2D82',
      description: "Dans ce jardin paisible de Madinah, le Prophète ﷺ s'assit au bord de ce puits et y laissa tomber sa bague. Un espace à écart du tumulte, rarement visité, qui offre une intimité spirituelle rare aux pèlerins qui le connaissent.",
...
const DURATIONS: Record<string, { time: string; dist?: string }> = {
  ...
  'hira':               { time: '~2h total', dist: '8 km de Makkah' },
  'zamzam':             { time: 'Sur place', dist: 'Dans le Haram' },
  'hunayn':             { time: '~2h', dist: '15 km de Makkah' },
  'masjid-fateh':       { time: '~45 min', dist: '4 km de Madinah' },
  'marche-dattes':      { time: '~1h', dist: '2 km du An-Nabawi' },
  'khandaq':            { time: '~1h', dist: '3 km de Madinah' },

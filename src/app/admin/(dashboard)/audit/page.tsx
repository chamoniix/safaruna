...
const ACTION_COLORS: Record<string, string> = {
  ...
  GUIDE_PROFILE_SUBMITTED_FOR_REVIEW: '#C9A84C',
  GUIDE_RESERVATION_DECLINED_AND_SUSPENDED: '#DC2626',
  GUIDE_NO_RESPONSE_AND_SUSPENDED: '#DC2626',
  GUIDE_RESERVATION_INCIDENT_COUNTED: '#DC2626',
  GUIDE_RESERVATION_INCIDENT_EXCUSED: '#1D5C3A',
...
const ACTION_LABELS: Record<string, string> = {
  ...
  GUIDE_PROFILE_SUBMITTED_FOR_REVIEW: 'Profil Guide soumis',
  GUIDE_RESERVATION_DECLINED_AND_SUSPENDED: 'Réservation refusée · Guide suspendu',
  GUIDE_NO_RESPONSE_AND_SUSPENDED: 'Absence de réponse · Guide suspendu',
  GUIDE_RESERVATION_INCIDENT_COUNTED: 'Incident Guide comptabilisé',
  GUIDE_RESERVATION_INCIDENT_EXCUSED: 'Incident Guide non comptabilisé',

...
export const metadata: Metadata = {
  ...
  description: "Découvrez ce que signifie vivre la Omra avec un guide privé SAFARUMA : accompagnement spirituel personnalisé, histoire des lieux historiques, sérénité sur place.",

...
export const PLACES: Place[] = [
  // ── MAKKAH ────────────────────────────────────
  {
    ...
    tagline: 'La plus grande mosquée du monde',
  ...
  },
  {
    ...
    nameFr: 'La Kaaba',
    tagline: 'Le sanctuaire vers lequel se tournent les musulmans',
  ...
  },
  {
    ...
    tagline: "Source d'eau bénite depuis Hagar",
  ...
  },
  {
    ...
    tagline: "Parcours rituel du Sa'i en 7 passages",
  ...
  },
  {
    ...
    nameAr: 'جبل النور',
    nameFr: 'Jabal Nour',
    tagline: 'Lieu de la première révélation coranique',
  ...
  },
  {
    ...
    tagline: "La grotte où l'ange Jibrîl apparut au Prophète ﷺ",
  ...
  },
  {
    ...
    nameAr: 'جبل ثور',
    nameFr: 'Jabal Thawr',
    tagline: "Refuge du Prophète ﷺ lors de l'Hégire",
  ...
  },
  {
    ...
    nameAr: 'عرفات',
    nameFr: 'Arafat',
    tagline: "Plaine du pilier central du Hajj · Sermon d'Adieu",
  ...
  },
  {
    ...
    nameAr: 'مزدلفة',
    nameFr: 'Muzdalifah',
    tagline: 'Halte sacrée entre Arafat et Mina',
  ...
  },
  {
    ...
    nameAr: 'منى',
    nameFr: 'Mina',
    tagline: 'La Cité des Tentes · Jamarat du Hajj',
  ...
  // ── MADINAH ───────────────────────────────────
  {
    ...
    tagline: 'La mosquée du Prophète ﷺ · 1000x la prière',
  ...
  },
  {
    ...
    nameFr: 'La Rawdah',
    tagline: 'Le jardin du Paradis entre le minbar et la tombe',
  ...
  },
  {
    ...
    tagline: 'Mosquée du changement de Qibla · miracle coranique',
  ...
  },
  {
    ...
    nameAr: 'أحد',
    nameFr: 'Mont Ohoud',
    tagline: "Site de la bataille d'Ohoud · martyrs et Hamza (ra)",
  ...
  },
  {
    ...
    tagline: "Mosquée de la Victoire · du'a exaucé du Prophète ﷺ",
  ...
  },
  {
    ...
    tagline: 'Dattes Ajwa et variétés rares de Madinah',
  ...
  // ── HISTORIQUE ────────────────────────────────
  {
    ...
    nameAr: 'بدر',
    nameFr: 'Badr',
    tagline: "Première grande victoire de l'Islam · 313 contre 1000",
  ...
  },
  {
    ...
    nameAr: 'الخندق',
    nameFr: 'Al-Khandaq',
    tagline: 'La Bataille du Fossé · stratégie de Salman Al-Farisi',
  ...
  },
  {
    ...
    nameAr: 'حنين',
    nameFr: 'Hunayn',
    tagline: 'Vallée mentionnée dans le Coran · bataille de Hunayn',
  ...
  },
  {
    ...
    nameAr: 'بئر أريس',
    nameFr: 'Bir Aris',
    tagline: 'Puits béni où le Prophète ﷺ pria · lieu rare',
  ...
  },
  {
    ...
    tagline: "Lieu de la prière de l'Aïd du Prophète ﷺ · mosquée ottomane",

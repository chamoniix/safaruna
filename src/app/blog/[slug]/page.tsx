...
const CONTENT: Record<string, { sections: { heading?: string; body: string }[]; faqs?: { q: string; a: string }[] }> = {
  'comment-preparer-omra-10-etapes': {
    sections: [
      { body: "La omra ne s'improvise pas. Elle se prépare — spirituellement, administrativement, physiquement. Les pèlerins qui arrivent sans préparation accomplissent les gestes sans les vivre. Ceux qui préparent vivent une transformation. Voici les 10 étapes pour que rien ne soit laissé au hasard." },
      { heading: 'Étape 1 — Faire l\'intention (Niyya)', body: "Tout commence par l'intention pure. La omra n'a de valeur que si elle est faite uniquement pour Allah. Commencez dès aujourd'hui à purifier votre intention : ne partez pas pour montrer, pour poster, pour cocher une case. Partez pour revenir transformé. C'est la seule préparation qui compte vraiment." },
      ...
      { heading: 'Étape 5 — Réserver votre guide SAFARUMA', body: "Votre guide est la clé de tout. Il vous accueillera à l'aéroport, vous expliquera chaque geste dans votre langue, vous emmènera dans les lieux historiques, et sera disponible pour vos questions à toute heure. Réservez au minimum 6 semaines à l'avance pour les meilleures disponibilités." },
  ...
  'guide-visa-omra': {
    ...
    faqs: [
      ...
      { q: "Peut-on faire la omra avec un visa touristique ?", a: "Techniquement oui — l'accès à la Masjid Al-Haram est possible avec un visa touristique. Mais vous n'obtenez pas le permis Omra (izin) via Nusuk, ni l'accès prioritaire à la Rawdah de Médine. Pour un véritable pèlerinage, le visa Omra dédié reste préférable." },
      { q: "Une femme peut-elle faire la omra seule en 2026 ?", a: "Oui. Le mahram n'est plus obligatoire pour la omra depuis la réforme saoudienne de 2021-2022. Condition : être majeure (18 ans +) et voyager dans le cadre d'un groupe ou via une agence agréée. Aucune limite d'âge n'est imposée par le gouvernement saoudien." },
      { q: "Faut-il un mahram pour la femme qui fait la omra ?", a: "Non, pour la omra. La femme majeure (18 ans +) peut voyager seule à condition d'être inscrite dans un groupe agréé ou via une agence reconnue. Pour le Hajj 2026, la même règle s'applique si elle voyage avec un groupe officiel enregistré sur Nusuk Hajj." },
  ...
  'difference-omra-hajj': {
    sections: [
      ...
      { heading: 'La définition fondamentale', body: "La omra est un pèlerinage mineur, accompli à tout moment de l'année. Le Hajj est le cinquième pilier de l'Islam, obligatoire une fois dans la vie pour tout musulman qui en a la capacité, et qui ne peut s'accomplir qu'à des dates très précises : du 8 au 13 Dhul Hijja (le douzième mois du calendrier islamique)." },
      { heading: 'Ce que la omra et le Hajj ont en commun', body: "Les deux pèlerinages partagent plusieurs rituels fondamentaux :\n\n🕌 L'état d'Ihram : vêtements blancs, interdictions rituelles, prononciation du Talbiyah\n🕌 Le Tawaf autour de la Kaaba : 7 tours anti-horaires\n🕌 Le Sa'i : 7 passages entre Safa et Marwa\n🕌 Le rasage ou la coupe des cheveux pour sortir de l'état d'Ihram\n🕌 La prière à Masjid Al-Haram (Makkah)" },
      ...
      { heading: 'Le statut religieux', body: "La omra est Sunna Mu'akkada — une pratique prophétique fortement recommandée. L'accomplir est une récompense immense, mais ne pas l'accomplir n'est pas un péché. Le Hajj, lui, est Fard — une obligation divine pour tout musulman qui en a la capacité physique et financière. Ne pas l'accomplir alors qu'on en était capable est considéré comme une faute grave par la majorité des savants." },
      { heading: 'La récompense de la omra', body: "Le Prophète ﷺ a dit : «L'Omra est une expiation pour les péchés commis entre elle et la suivante. Et le Hajj mabrur n'a pas d'autre récompense que le Paradis.» (Bukhari & Muslim). Même si la Omra est facultative, sa valeur devant Allah est immense. Certains savants recommandent d'accomplir la Omra au moins une fois par an si on en a la capacité." },
      { heading: 'Peut-on faire la omra pendant le Hajj ?', body: "Oui. Il existe même plusieurs façons de les combiner :\n\n✦ Hajj Tamattu' : Omra d'abord, puis Hajj séparément (en sortant de l'ihram entre les deux)\n✦ Hajj Qiran : Omra et Hajj avec un seul ihram continu\n✦ Hajj Ifrad : Hajj seul, sans Omra\n\nLa majorité des pèlerins francophones pratiquent le Hajj Tamattu'." },
      { heading: 'Pourquoi commencer par la omra ?', body: "La plupart des savants recommandent d'accomplir la Omra avant le Hajj. C'est une façon de découvrir les Lieux historiques, d'apprendre les rituels dans un cadre moins intense, et d'arriver au Hajj avec une expérience déjà acquise. SAFARUMA propose des programmes Omra qui sont aussi une préparation au Hajj — avec des guides qui vous enseignent les rituels des deux pèlerinages." },
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '0.82rem', color: 'var(--muted)', lineHeight: 1.7 }}>
                Guide certifié SAFARUMA avec des années d&apos;expérience à Makkah et Madinah. Ses articles sont écrits directement depuis les Lieux historiques, avec la précision de quelqu&apos;un qui y vit chaque jour.
              </p>
            </div>
          </div>
        </div>

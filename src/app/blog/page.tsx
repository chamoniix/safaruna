...
export const ARTICLES = [
  {
    slug: 'comment-choisir-guide-omra',
    category: 'Conseils',
    categoryColor: '#8B6914',
    categoryBg: 'rgba(201,168,76,0.1)',
    title: 'Comment bien choisir son guide pour l\'Omra',
    excerpt: "Le choix du guide est la décision la plus importante de votre Omra. Voici les 7 critères que chaque pèlerin devrait vérifier avant de réserver.",
    readTime: '6 min',
    date: '12 mars 2026',
    author: 'Soukaïna Kettani',
    authorRole: 'Head of Guides · SAFARUNA',
    featured: true,
  },
  {
    slug: '10-lieux-incontournables-makkah',
    category: 'Lieux Saints',
    categoryColor: '#1A4A8A',
    categoryBg: 'rgba(26,74,138,0.1)',
    title: 'Les 10 lieux incontournables à Makkah au-delà du Haram',
    excerpt: "Grotte de Hira, Jabal Thawr, Meeqat de Tan'im… Ces lieux chargés d'histoire sont souvent ignorés par les groupes organisés. Un guide privé vous y emmène.",
    readTime: '8 min',
    date: '5 mars 2026',
  ...
  {
    slug: 'checklist-preparation-omra',
    category: 'Préparation',
    categoryColor: '#1D5C3A',
    categoryBg: 'rgba(29,92,58,0.1)',
    title: 'Checklist complète pour préparer votre Omra',
    excerpt: "Documents, médicaments, vêtements, applications mobiles, habitudes spirituelles à instaurer avant le départ — tout ce qu'il faut préparer, 3 mois à l'avance.",
    readTime: '10 min',
  ...
  {
    slug: 'grotte-hira-guide-spirituel',
    category: 'Spiritualité',
    categoryColor: '#5A2D82',
    categoryBg: 'rgba(90,45,130,0.1)',
    title: 'La Grotte de Hira : guide spirituel et pratique',
    excerpt: "215 mètres de dénivelé pour atteindre le lieu où tout a commencé. Ce que le Coran dit de cet endroit, comment s'y préparer, et ce qu'on y ressent.",
    readTime: '7 min',
  ...
  {
    slug: 'omra-famille-conseils-guide',
    category: 'Famille',
    categoryColor: '#C05A10',
    categoryBg: 'rgba(192,90,16,0.1)',
    title: 'Omra en famille avec enfants : conseils d\'un guide certifié',
    excerpt: "Partir en Omra avec des enfants de 5 à 14 ans est possible et profondément transformateur — à condition de bien s'organiser. Rachid Al-Madani partage ses secrets.",
    readTime: '9 min',

...
export default function GuideReviewsPage() {
  ...
  return (
    <div style={{ display: 'grid', gap: 18 }}>
      ...
      {!loading && !error && reviews.length === 0 && <div style={{ padding: 36, background: 'white', border: '1px solid #E8DFC8', borderRadius: 14, textAlign: 'center', color: '#7A6D5A' }}>Nouveau guide — aucun avis pour le moment.</div>}

...
const LIEUX: Record<'Makkah' | 'Madinah', LieuSimple[]> = {
  ...
  Madinah: [
    ...
    },
    {
      ...
      tagColor: '#8B2A1A',
      description: "Le Prophète ﷺ a dit : «Uhud est une montagne qui nous aime et que nous aimons.» Lieu de la bataille d'Uhud (an 3 de l'Hégire), où 70 Compagnons tombèrent en martyre, dont Hamza ibn Abd Al-Muttalib ﷺ, l'oncle bien-aimé du Prophète ﷺ.",
    ...
    },
    {
      ...
      tagColor: '#1A4A8A',
      description: "Un ensemble de sept petites mosquées marquant les positions tenues par le Prophète ﷺ et ses Compagnons lors de la Bataille du Fossé (Al-Khandaq). Sur la suggestion de Salman Al-Farisi ﷺ, les musulmans creusèrent un fossé de plusieurs kilomètres pour défendre Madinah.",
